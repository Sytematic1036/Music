"""
Extended player module with Rearrange tab - EXP-005 Logic-Style Scrolling.

Based on EXP-004 v3 - ONLY adds scrolling/playhead features:
- Vertical + horizontal scrollbars (always visible)
- Ruler with beat markers
- Clickable ruler to jump in time
- Playhead triangle showing position
- Auto-scroll (catch mode) during playback

NO CHANGES to:
- Audio/MIDI rendering (FluidSynth)
- File handling
- Note editing
- Anything else
"""
...
# HTML template - EXP-005 with Logic-style scrolling
BROWSER_PLAYER_SCROLLING_HTML = """<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Music Player - EXP-005 Logic-Style Scrolling</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* EXP-005: Scroll container with always-visible scrollbars */
        .scroll-container {
            margin-left: 50px;
            height: 400px;
            overflow: scroll; /* NOT auto - always visible */
            position: relative;
        }
...
<body>
    ...
    <div class="tab-content" id="tab-rearrange">
        <div class="rearrange-panel">
            <h2>Piano Roll Editor - EXP-005 Scrolling</h2>

            <div class="info-banner">
                <strong>EXP-005:</strong> Logic-style scrollbars + ruler + playhead!
                <br>Click ruler to jump, playhead follows during playback.
            </div>
    ...
    <!-- CRITICAL: Use unpkg.com for UMD version that works in browser -->
    ...
    <script>
        ...
        // ============================================
        // REARRANGE TAB - EXP-005 with scrolling
        // ============================================
        const pianoRoll = {
            canvas: null,
            ctx: null,
            ...
            snap: 0.5,
            tempo: 120,
            duration: 60,  // Total duration in beats

            isPlaying: false,
            playbackPosition: 0,  // In beats
            audioElement: null,

            // EXP-005: Scrolling elements
            ...
            init() {
                ...
                // EXP-005: Initialize scrolling elements
            ...
            setupPianoKeys() {
                ...
                // Set height to match scroll container
                ...
                // Sync piano keys scroll with main scroll
            ...
            // EXP-005: Render ruler with beat markers and playhead triangle
            renderRuler() {
            ...
            async startPlayback() {
                ...
                try {
                    ...
                    // EXP-005: Update playhead on timeupdate
...
class PlayerHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if parsed.path == '/' or parsed.path == '/player.html':
            ...
            self.end_headers()
            self.wfile.write(BROWSER_PLAYER_SCROLLING_HTML.encode())
...
if __name__ == "__main__":
    ...
    print("Starting EXP-005 Logic-Style Scrolling Player...")
    print("NEW: Scrollbars + Ruler + Playhead + Catch mode!")
    print()
